...
znormed_ffostare_v1 <- read_excel("composite_variables/znormed_ffostare_v1.xlsx")
...
```{r}
selected_norms_composites_demgraf_v1 <- read_excel("composite_variables/selected_norms_composites_demgraf_v1.xlsx")
