...
SEM_comp1_fit <- cfa(model = SEM_comp1, estimator = "MLR", data = selected_norms_ffostare_v1)
...
SEM_comp2_fit <- cfa(model = SEM_comp2, estimator = "MLR", data = selected_norms_ffostare_v1)
...
SEM_comp3_fit <- cfa(model = SEM_comp3, estimator = "MLR", data = selected_norms_ffostare_v1)
...
SEM_comp4_fit <- cfa(model = SEM_comp4, estimator = "MLR", data = selected_norms_ffostare_v1)
