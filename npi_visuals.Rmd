...
**Object_Oriented** = "ZMouth Object",
               "ZTouch Object",
               "ZManipulate Object",
               "ZInspect Object",
                "ZSteal Resource Attempt",
               "ZSteal Resource Attempt count"
...
#test
social_affiliative_vR_33_ttest_unpaired <- wilcox.test(social_affiliative_vR_33$social_affiliative~social_affiliative_vR_33$diet_group, paired=FALSE)
...
customviz_affil_vR50+labs(title="Social Non-Affiliative Behaviors (CTR=1, PR=2)", x="Diet",y="Non-Affiliative Behavior")  +
  scale_color_manual(values = wes_palette(n=2, "GrandBudapest1")) +
  theme(plot.background = element_rect(fill = "light gray"),
        panel.background = element_rect(fill = "dark gray"),
        legend.background = element_rect(fill = "dark gray"))
